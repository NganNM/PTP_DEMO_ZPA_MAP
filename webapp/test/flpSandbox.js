					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Khai báo chỉ tiêu báo cáo thực hiện",
									"targetURL": "#zpamap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zpamap-display": {
								"semanticObject": "zpamap",
								"action": "display",
								"description": "Khai báo chỉ tiêu báo cáo thực hiện",
								"title": "Khai báo chỉ tiêu báo cáo thực hiện",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpamap",
									"url": sap.ui.require.toUrl("zpamap")
								}
							}
						}
					}
